...
const About = () => {
  return (
    <div className="flex bg-slate-900 mt-10 rounded-3xl  w-3/4 mx-auto p-10  md:justify-center md:items-center ">
      <div className="flex flex-col  md:flex-row">
        <div className="flex-1 p-4 rounded-2xl bg-white">
          <img className="w-96 rounded-2xl" src={"usman-ghani.png"} alt="Usman Ghani" />
        </div>
